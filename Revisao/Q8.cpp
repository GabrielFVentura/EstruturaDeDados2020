...
int main()
{
    ...
    // {
    //     cin >> id >> nome >> idade >> peso >> sexo;
    //     Corredor corredores[i] = Corredor(id,nome,idade,peso,sexo);
    // }

    // cout << 
    // corredores[0].codigoAtleta << 
    // corredores[0].primeiroNome << 
    // corredores[0].idade << 
    // corredores[0].peso << 
    // corredores[0].sexo;
