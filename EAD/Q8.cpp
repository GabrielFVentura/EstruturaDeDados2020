...
OBS: Letras maiúsculas e minúsculas são diferenciadas. A matriz deve ser alocada dinamicamente. A função strlen retorna o tamanho de uma string. Não é necessário usar os mesmos nomes do enunciado.
