...
class Benfeitor{
    private:
        ...
        int _qtdDoacao;
        float _valorDoacao[50];
        float _valorTotalDoacaoBenfeitor;
    ...
    public:
        ...
        Benfeitor(string n, float v = 0, bool pj = false){
        ...
        void adicionarDoacao(float v, ONG* ong);
        ...
        bool procurarValorDoacaoBenfeitor(float v){
            for (int i = 0; i < getQtdDoacao(); i++){
                if (_valorDoacao[i] == v){
                    return true;
                }
        ...
        string resultadoProcurarValorDoacaoPorBenfeitor(float v){
            return procurarValorDoacaoBenfeitor(v) == true ? "Valor da Doacao encontrado" : "Valor nao encontrado para esse Benfeitor";
        }
};
...
class ONG{
    ...
    public:
        ...
        void adicionarValorTotalDado(float v){
            _valorTotalDoado += v;
        }

        void cadastrarBenfeitor(string nomeBenfeitor, float v = 0, bool pj = false){
        ...
        void procurarValoresPorBenfeitores(float v){
        ...
        void adicionarDoacaoPorBenfeitor(string nomeBenfeitor, float valorDoacao){
            for (int i = 0; i < getNumeroBenfeitores(); i++){
...
void Benfeitor::adicionarDoacao(float v, ONG* ong){
    _valorDoacao[getQtdDoacao()] = v;
    _valorTotalDoacaoBenfeitor += v;
    incrementaQtdDoacao();
...
int main(){
    ...
    ong._benfeitores[0]->adicionarDoacao(1000.50, &ong);
    ong._benfeitores[1]->adicionarDoacao(100.25, &ong);
